...
var args52402 = [];
var len__45257__auto___52406 = arguments.length;
var i__45258__auto___52407 = (0);
while(true){
if((i__45258__auto___52407 < len__45257__auto___52406)){
args52402.push((arguments[i__45258__auto___52407]));

var G__52408 = (i__45258__auto___52407 + (1));
i__45258__auto___52407 = G__52408;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,G__52405,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__52405;
}
});
...
var or__44182__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__45257__auto___52413 = arguments.length;
var i__45258__auto___52414 = (0);
while(true){
if((i__45258__auto___52414 < len__45257__auto___52413)){
args__45264__auto__.push((arguments[i__45258__auto___52414]));

var G__52415 = (i__45258__auto___52414 + (1));
i__45258__auto___52414 = G__52415;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45265__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq52410){
var G__52411 = cljs.core.first.call(null,seq52410);
var seq52410__$1 = cljs.core.next.call(null,seq52410);
var G__52412 = cljs.core.first.call(null,seq52410__$1);
var seq52410__$2 = cljs.core.next.call(null,seq52410__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__52411,G__52412,seq52410__$2);
});
...
var map__52419 = m;
var map__52419__$1 = ((((!((map__52419 == null)))?((((map__52419.cljs$lang$protocol_mask$partition0$ & (64))) || (map__52419.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52419):map__52419);
var file = cljs.core.get.call(null,map__52419__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__52419__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__52419__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__52419,map__52419__$1,file,line,column){
return (function (p1__52416_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__52416_SHARP_));
});})(map__52419,map__52419__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__45107__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__45107__auto__,prefer_table__45108__auto__,method_cache__45109__auto__,cached_hierarchy__45110__auto__,hierarchy__45111__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__44182__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__44182__auto__)){
return or__44182__auto__;
} else {
...
var temp__4657__auto___52421 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___52421)){
var message_52422 = temp__4657__auto___52421;
cljs.core.println.call(null,message_52422);
} else {
}
...
var temp__4657__auto___52423 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___52423)){
var message_52424 = temp__4657__auto___52423;
cljs.core.println.call(null,message_52424);
} else {
}
...
var temp__4655__auto__ = (function (){var and__44170__auto__ = typeof exception.stack === 'string';
if(and__44170__auto__){
var G__52434 = exception.stack;
var G__52434__$1 = (((G__52434 == null))?null:clojure.string.split_lines.call(null,G__52434));
var G__52434__$2 = (((G__52434__$1 == null))?null:cljs.core.get.call(null,G__52434__$1,depth));
if((G__52434__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__52434__$2);
}
} else {
...
var vec__52435 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__52435,(0),null);
var column = cljs.core.nth.call(null,vec__52435,(1),null);
var vec__52438 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__52438,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__52438,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__52438,(2),null);
...
var m__$1 = (function (){var G__52442 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__52442) {
case "fail":
...
var G__52448 = (function (){var G__52447 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__52447);
} else {
return G__52447;
}
})();
...
return cljs.core.vary_meta.call(null,G__52450,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e52453){var e = e52453;
var G__52454 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__52454) {
...
var vec__52459 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__52459,(0),null);
var types = vec__52459;
...
return cljs.core.map.call(null,(function (p__52471){
var vec__52472 = p__52471;
var ns = cljs.core.nth.call(null,vec__52472,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__52472,(1),null);
return ((function (vec__52472,ns,vars__$1){
return (function (){
...
var G__52475 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__52475) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1){
return (function (){
var seq__52476 = cljs.core.seq.call(null,vars__$1);
var chunk__52477 = null;
var count__52478 = (0);
var i__52479 = (0);
while(true){
if((i__52479 < count__52478)){
var v = cljs.core._nth.call(null,chunk__52477,i__52479);
var temp__4657__auto___52481 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___52481)){
var t_52482 = temp__4657__auto___52481;
each_fixture_fn.call(null,((function (seq__52476,chunk__52477,count__52478,i__52479,t_52482,temp__4657__auto___52481,v,each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_52482)));
});})(seq__52476,chunk__52477,count__52478,i__52479,t_52482,temp__4657__auto___52481,v,each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1))
);
} else {
}

var G__52483 = seq__52476;
var G__52484 = chunk__52477;
var G__52485 = count__52478;
var G__52486 = (i__52479 + (1));
seq__52476 = G__52483;
chunk__52477 = G__52484;
count__52478 = G__52485;
i__52479 = G__52486;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__52476);
if(temp__4657__auto__){
var seq__52476__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__52476__$1)){
var c__44993__auto__ = cljs.core.chunk_first.call(null,seq__52476__$1);
var G__52487 = cljs.core.chunk_rest.call(null,seq__52476__$1);
var G__52488 = c__44993__auto__;
var G__52489 = cljs.core.count.call(null,c__44993__auto__);
var G__52490 = (0);
seq__52476 = G__52487;
chunk__52477 = G__52488;
count__52478 = G__52489;
i__52479 = G__52490;
continue;
} else {
var v = cljs.core.first.call(null,seq__52476__$1);
var temp__4657__auto___52491__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___52491__$1)){
var t_52492 = temp__4657__auto___52491__$1;
each_fixture_fn.call(null,((function (seq__52476,chunk__52477,count__52478,i__52479,t_52492,temp__4657__auto___52491__$1,v,seq__52476__$1,temp__4657__auto__,each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_52492)));
});})(seq__52476,chunk__52477,count__52478,i__52479,t_52492,temp__4657__auto___52491__$1,v,seq__52476__$1,temp__4657__auto__,each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1))
);
} else {
}

var G__52493 = cljs.core.next.call(null,seq__52476__$1);
var G__52494 = null;
var G__52495 = (0);
var G__52496 = (0);
seq__52476 = G__52493;
chunk__52477 = G__52494;
count__52478 = G__52495;
i__52479 = G__52496;
continue;
}
} else {
...
});})(each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1))
);
});})(each_fixture_fn,G__52475,env,once_fixtures,each_fixtures,vec__52472,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1481668787827