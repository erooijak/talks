...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__50883_SHARP_){
return ((p1__50883_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__50883_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__50885,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__50885;
}
});
...
var len__45257__auto___50888 = arguments.length;
var i__45258__auto___50889 = (0);
while(true){
if((i__45258__auto___50889 < len__45257__auto___50888)){
args__45264__auto__.push((arguments[i__45258__auto___50889]));

var G__50890 = (i__45258__auto___50889 + (1));
i__45258__auto___50889 = G__50890;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__45265__auto__);
});
...
var G__50887 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__50887,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__50887;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq50886){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50886));
});
...
var tag_name = cljs.core.nth.call(null,vec__50896,(0),null);
var names = cljs.core.nth.call(null,vec__50896,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__50896,tag_name,names){
return (function (p1__50891_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__50891_SHARP_));
});})(matches,vec__50896,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__50896,tag_name,names){
return (function (p1__50892_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__50892_SHARP_));
});})(matches,vec__50896,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__50899){
var vec__50906 = p__50899;
var seq__50907 = cljs.core.seq.call(null,vec__50906);
var first__50908 = cljs.core.first.call(null,seq__50907);
var seq__50907__$1 = cljs.core.next.call(null,seq__50907);
var tag = first__50908;
var content = seq__50907__$1;
...
var vec__50909 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__50909,(0),null);
var id = cljs.core.nth.call(null,vec__50909,(1),null);
var class$ = cljs.core.nth.call(null,vec__50909,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1481668786262