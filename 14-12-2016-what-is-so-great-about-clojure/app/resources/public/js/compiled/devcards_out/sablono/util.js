...
var x__44845__auto__ = (((x == null))?null:x);
var m__44846__auto__ = (sablono.util.to_str[goog.typeOf(x__44845__auto__)]);
if(!((m__44846__auto__ == null))){
return m__44846__auto__.call(null,x);
} else {
var m__44846__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__44846__auto____$1 == null))){
return m__44846__auto____$1.call(null,x);
} else {
...
var x__44845__auto__ = (((x == null))?null:x);
var m__44846__auto__ = (sablono.util.to_uri[goog.typeOf(x__44845__auto__)]);
if(!((m__44846__auto__ == null))){
return m__44846__auto__.call(null,x);
} else {
var m__44846__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__44846__auto____$1 == null))){
return m__44846__auto____$1.call(null,x);
} else {
...
var len__45257__auto___50869 = arguments.length;
var i__45258__auto___50870 = (0);
while(true){
if((i__45258__auto___50870 < len__45257__auto___50869)){
args__45264__auto__.push((arguments[i__45258__auto___50870]));

var G__50871 = (i__45258__auto___50870 + (1));
i__45258__auto___50870 = G__50871;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__45265__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq50868){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50868));
});
...
var vec__50875 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__50877;
var words = seq__50876__$1;
...
var G__50879 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__50879,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__50879;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__50880_SHARP_){
if(typeof p1__50880_SHARP_ === 'string'){
return p1__50880_SHARP_;
} else {
return cljs.core.seq.call(null,p1__50880_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__44182__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1481668786208