...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44796__auto__,writer__44797__auto__,opt__44798__auto__){
return cljs.core._write.call(null,writer__44797__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__46003 = o;
(G__46003[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__46005__i < G__46005__a.length) {G__46005__a[G__46005__i] = arguments[G__46005__i + 0]; ++G__46005__i;}
  args = new cljs.core.IndexedSeq(G__46005__a,0);
} 
...
if(cljs.core.truth_((function (){var and__44178__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__44178__auto__){
var and__44178__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__46012 = jsprops;
(G__46012["defaultValue"] = value);

(G__46012["onChange"] = ((function (G__46012,v,value,on_change){
return (function (p1__46009_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__46009_SHARP_);
});})(G__46012,v,value,on_change))
);

(G__46012["ref"] = ((function (G__46012,v,value,on_change){
return (function (p1__46010_SHARP_){
return (this$["cljsInputElement"] = p1__46010_SHARP_);
});})(G__46012,v,value,on_change))
);
...
var vec__46019 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46019,(0),null);
var id = cljs.core.nth.call(null,vec__46019,(1),null);
var class$ = cljs.core.nth.call(null,vec__46019,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___46024 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___46024 == null)){
} else {
var key_46025 = temp__4661__auto___46024;
(jsprops["key"] = key_46025);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__46027 = (new reagent.impl.template.NativeWrapper());
(G__46027["name"] = c);
...
var len__45265__auto___46033 = arguments.length;
var i__45266__auto___46034 = (0);
while(true){
if((i__45266__auto___46034 < len__45265__auto___46033)){
args__45272__auto__.push((arguments[i__45266__auto___46034]));

var G__46035 = (i__45266__auto___46034 + (1));
i__45266__auto___46034 = G__46035;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45273__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46031){
var G__46032 = cljs.core.first.call(null,seq46031);
var seq46031__$1 = cljs.core.next.call(null,seq46031);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__46032,seq46031__$1);
});
...
break;
default:
var G__46039 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__46039;
continue;
...
var n__45105__auto___46042 = a.length;
var i_46043 = (0);
while(true){
if((i_46043 < n__45105__auto___46042)){
(a[i_46043] = reagent.impl.template.as_element.call(null,(a[i_46043])));

var G__46044 = (i_46043 + (1));
i_46043 = G__46044;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__45105__auto___46045 = a.length;
var i_46046 = (0);
while(true){
if((i_46046 < n__45105__auto___46045)){
var val_46047 = (a[i_46046]);
if((cljs.core.vector_QMARK_.call(null,val_46047)) && ((reagent.impl.template.key_from_vec.call(null,val_46047) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46046] = reagent.impl.template.as_element.call(null,val_46047));

var G__46048 = (i_46046 + (1));
i_46046 = G__46048;
continue;
} else {
}
...
var ctx = ({});
var vec__46052 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__46052,(0),null);
var derefed = cljs.core.nth.call(null,vec__46052,(1),null);
...
var G__46056 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46056) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__46056){
...
//# sourceMappingURL=template.js.map?rel=1481669439812