...
\usepackage{minted}
\usetheme{metropolis}
\setbeamertemplate{frame footer}{\color{lightgray}Jeroen Bruijn, Ruud Hendrikx, Elisa Achterberg \& Erwin Rooijakkers - Vegan en Beyond}
\metroset{block=fill}
\usetheme{default}
